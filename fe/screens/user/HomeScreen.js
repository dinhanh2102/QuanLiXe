    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBarContainer}>
        ...
        <View style={styles.topbarlogoContainer}>
          ...
          <Text style={styles.toBarText}>Car ShowRoom</Text>
        </View>
        <TouchableOpacity
